		...
		<table class="table table-sm table-hover table-bordered table-striped" id="bestPrices">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-right col-1 pr-3 {if $fillTypeData.greatDemand}text-info{elseif $percent>=60}text-success{elseif $percent<=40}text-danger{/if}">
					...
					<td class="text-right col-1 pr-3">{$commodities.$fillType.overall|number_format:0:",":"."}</td> {math equation="overall * bestPrice / 1000"
